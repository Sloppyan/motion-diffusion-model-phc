...
def add_training_options(parser):
    ...
    group.add_argument("--train_platform_type", default='NoPlatform', choices=['NoPlatform', 'ClearmlPlatform', 'TensorboardPlatform', 'WandbPlatform', 'WandBPlatform'], type=str,
                       help="Choose platform to log results. NoPlatform means no logging.")
    group.add_argument("--wandb_run_name", default="", type=str,
                       help="Required when using WandbPlatform/WandBPlatform.")
